...
public class WeatherForecastController {
    ...
    public ResponseEntity<?> getWeatherForecastByCityIdAndAppID( @PathVariable("cityId") String cityId,
        ...
        if( cityId != null && appId != null ) {
            Log.info("Fetching weather details with cityId: {}", cityId);
            WeatherForecastResponse weatherForecastResponse = weatherForecastService.getWeatherForecastByCityIdAndAppID(cityId);
    ...
    public ResponseEntity<?> getWeatherForecastByCityIdAndAppIDWithHeader( @PathVariable("cityId") String cityId) throws Exception {
